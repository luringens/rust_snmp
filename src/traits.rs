...
impl EncodeSnmp for u8 {
    fn encode_snmp(&self) -> Vec<u8> {
        vec![0x02 /* Integer type */, 0x01 /* Length */, *self /* Value */]
    }
}
...
impl EncodeSnmp for i16 {
    fn encode_snmp(&self) -> Vec<u8> {
        ...
        vec![0x02 /* Integer type */, 0x02 /* Length */, values[0], values[1]]
    }
}
...
impl EncodeSnmp for i32 {
    fn encode_snmp(&self) -> Vec<u8> {
        ...
        vec![0x02 /* Integer type */, 0x04 /* Length */, values[0], values[1], values[2],
             values[3]]
    }
}
